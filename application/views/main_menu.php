	...
	<nav id="main-nav">
		...
		<ul class="container_12">
			<li <?php if($menu == 1){echo 'class="home current"';}else{echo 'class="home"';}?>><a href="#" title="Home">Home</a>
				<ul>
                    <li <?php if($submenu == 1.1){echo 'class="current"';}?>><?php echo anchor('cuentas/cobrar/1.1', 'Cuentas por cobrar'); ?></li>
                    <li <?php if($submenu == 1.2){echo 'class="current"';}?>><?php echo anchor('cuentas/pagar/1.2', 'Cuentas por pagar'); ?></li>
                    <li <?php if($submenu == 1.3){echo 'class="current"';}?>><?php echo anchor('cuentas/indicadores/1.3', 'Indicadores'); ?></li>
				</ul>
			</li>
			...
			<li <?php if($menu == 4){echo 'class="pedidos current"';}else{echo 'class="pedidos"';}?>><?php echo anchor('pedidos', 'Pedidos', 'title="Pedidos"');?>
				<ul>
					<li <?php if((double)$submenu === (double)4.1){echo 'class="current"';}?>><?php echo anchor('pedidos/nuevo_pedido', 'Nuevo Pedido')?></li>
					...
					<li <?php if($submenu == 4.8){echo 'class="current"';}?>><?php echo anchor('pedidos/entregados', 'Entregados')?></li>
					<li <?php if($submenu == 4.9){echo 'class="current"';}?>><?php echo anchor('pedidos/pagados', 'Pagados')?></li>
					...
					<li <?php if((double)$submenu === (double)4.10){echo 'class="current"';}?>><?php echo anchor('pedidos/empleados', 'Empleados')?></li>
				</ul>
			</li>
			<li <?php if($menu == 5){echo 'class="clientes current"';}else{echo 'class="clientes"';}?>><a href="#" title="Clientes">Clientes</a>
				<ul>
					<li <?php if($submenu == 5.1){echo 'class="current"';}?>><?php echo anchor('sucursales/catalogo', 'Catalogo de Clientes')?></li>
				</ul>
			</li>
