...
<caption>Registros encontrados: <?php echo $query->num_rows();?></caption>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="right"><?php echo anchor('stats/detalle_negados/'.$row->clave.'/'.$perini.'/'.$perfin, number_format($row->negados, 0), array('class' => 'elige', 'tittle' => $row->descripcion." CLAVE: ".$row->clave)) ?></td>
