        ...
        <div class="block-content">
            <h1>
                        ...
                        <?php
                            ...
                            echo anchor('inv/inv_imprimir/', img($image).' imprimir', array('target' => '_blank'));
                        ?>
                        
            </h1>
            <p>
            
            <h2 align="center"><?php echo anchor('inv/inv_excel', 'Bajar Inventario a Excel', array('target' => '_blank'))?></h2>
