    ...
    <div class="block-border">
        ...
        <div class="block-content" id="formato">
            ...
            <p>
                ...
                <input type="text" name="susa" id="susa" value="<?php echo $row->susa?>" class="full-width" required="required" />
            </p>
            ...
            <p>
                ...
                <input type="number" name="precio_max" id="precio_max" value="<?php echo $row->precio_max?>" required="required" />
            </p>

            <p>
                <label for="precio_diva">Precio Diva</label>
                <input type="number" name="precio_diva" id="precio_diva" value="<?php echo $row->precio_diva?>" required="required" />
            </p>
