...
<div class="block-border">
    ...
    <div class="block-content">
                <?php echo form_open('pedidos/submit_captura_pedido_pagado', array('class' => 'form', 'id' => 'captura_clave_form'));?>
            <fieldset>
            <legend>Captura datos del pago</legend>
                ...
                <input type="text" name="forma" id="forma" required="required" />
                <br />
