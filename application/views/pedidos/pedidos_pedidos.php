            <p>
            <table class="table sortable" cellspacing="0" width="100%" style="font-size: smaller;">
							...
							<td class="table-actions" align="center">
                                ...
                                if($nivel == 2){
                                    ...
                                    if($row->estatus == 0){
                                        ...
                                        echo anchor('pedidos/previo_pedido/'.$row->id.'/'.$submenu, img($image3), array('title' => 'Impresion', 'class' => 'with-tip', 'target' => '_blank'));
                                        echo anchor('pedidos/cancela_pedido/'.$row->id, img($image6), array('title' => 'Cancela Pedido', 'class' => 'with-tip'));
                                        ...
                                        echo anchor('pedidos/entregado/'.$row->id.'/'.$submenu, img($image2), array('title' => 'Ver Detalle', 'class' => 'with-tip'));
                                        echo anchor('pedidos/pedido_embarque/'.$row->id.'/'.$submenu, img($image3), array('title' => 'Impresion', 'class' => 'with-tip', 'target' => '_blank'));
                                    }elseif($row->estatus == 5){
                                        echo anchor('pedidos/pedido_embarque/'.$row->id.'/'.$submenu, img($image3), array('title' => 'Impresion', 'class' => 'with-tip', 'target' => '_blank'));
                                    }elseif($row->estatus == 6){
                                        echo anchor('pedidos/pedido_embarque/'.$row->id.'/'.$submenu, img($image3), array('title' => 'Impresion', 'class' => 'with-tip', 'target' => '_blank'));
