            ...
            <caption>Registros: <?php echo count($query); ?></caption>
                    ...
                    ?>
						<tr>
							...
							<td style="text-align: left;"><?php echo $row->referencia;?></td>
							...
							<td class="table-actions" style="text-align: center;">
                                <?php 
                                        echo anchor('cuentas/pagar_parcialidad/'.$row->id, img($image2), array('title' => 'Ingresar parcialidad', 'class' => 'with-tip'));
                                        echo anchor('cuentas/detalle_parcialidades_pagar/'.$row->id, img($image1), array('class' => 'elige', 'tittle' => "Id entrada: ".$row->id.", Folio: ".$row->referencia.", Proveedor: ".$row->razon));
                                ?>
							</td>
						</tr>
                    <?php
